...
const ColorSystemSection = () => {
  ...
  const colors = brand.slug === "haramaincapture"
    ...
    ? [
        {
          number: "01",
          type: "PRIMARY BRAND GOLD",
          hex: "#FFD21C",
          name: "Hamasah Sun Gold",
          desc: "Warna keemasan hangat khas identitas Hamasah yang memancarkan optimisme, energi, dan kehangatan layanan.",
          swatchClass: "bg-[#FFD21C]",
        },
        {
          number: "02",
          type: "FRESH HYGIENIC CYAN",
          hex: "#0EA5E9",
          name: "Fresh Laundry Cyan",
          desc: "Aksen biru aqua/cyan segar melambangkan kemurnian air bersih, kesegaran busa, dan higienitas pencucian modern.",
          swatchClass: "bg-[#0EA5E9]",
        },
        {
          number: "03",
          type: "DEEP CLEAN ESPRESSO",
          hex: "#2C1A0D",
          name: "Deep Roast Contrast",
          desc: "Kontras cokelat tua mewah yang kokoh, memberikan wibawa brand dan keterbacaan tipografi yang tajam.",
          swatchClass: "bg-[#2C1A0D]",
        },
        {
          number: "04",
          type: "PURE COTTON NEUTRAL",
          hex: "#F8FAFC",
          name: "Soft Cotton White",
          desc: "Warna putih katun lembut sejuk yang melambangkan pakaian bersih, rapi, dan harum tahan lama.",
          swatchClass: "bg-[#F8FAFC] border border-black/10",
        },
      ]
